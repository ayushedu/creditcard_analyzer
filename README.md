...
## Usage
Edit the configuration in config.ini and execute "**python parser.py**". The excel file with extension .xlsx will be create
this line should be treated as duumy project line.
